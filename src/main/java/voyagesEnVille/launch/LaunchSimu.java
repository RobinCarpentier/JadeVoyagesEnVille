//Code de Rémi BRAEM Robin CARPENTIER
...
public class LaunchSimu {
    ...
    public static void main(String... args) {
        ...
        lesAgents.append("agentBike:voyagesEnVille.agents.AgenceAgent(./bike.csv);");
        lesAgents.append("agentCar:voyagesEnVille.agents.AgenceAgent(./car.csv);");
        lesAgents.append("agentBus:voyagesEnVille.agents.AgenceAgent(./bus.csv);");
        lesAgents.append("agentTram:voyagesEnVille.agents.AgenceAgent(./tram.csv);");
